...
\captionsetup[table]{labelfont=bf,labelsep=period,skip=10pt,justification=centering}
...
%
\author{Samuel Arseneault\orcidID{0000-0002-5119-9756} \and
David Vielfaure\orcidID{0000-0003-1807-5353} \and
Giovanni Beltrame\orcidID{0000-0001-9755-8630}}
%
\authorrunning{S. Arseneault et al.}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{Polytechnique Montréal, Montréal, Canada\\
\email{\{samuel,david,giovanni\}@polymtl.ca}\\}
%
...
\keywords{Swarm Robotics \and Information Sharing \and Robot Safety}
\end{abstract}
%
%
%
...
% \begin{figure}[h]
% 	\centering
%     \includegraphics[width=0.95\columnwidth]{figures/argos_grid_link.png}
...
% \begin{figure}[h]
% 	\centering
%     \includegraphics[width=0.95\columnwidth]{figures/argos_scale_free.png}
...
% \begin{figure}[h]
% 	\centering
%     \includegraphics[width=0.95\columnwidth]{figures/argos_random.png}
...
\multirow{\textbf{Grid-like}}     & Stigmergy & N.A.  & 100.00 \\ \hline
                                         & RASS      & 11.44 & 1.95   \\ \cline{2-4} 
                                         & Hop-Count & 6.85  & 0.50   \\ \cline{2-4} 
\multirow{\textbf{Scale-Free}}    & Stigmergy & N.A.  & 100.00 \\ \hline
                                         & RASS      & 12.51 & 1.69   \\ \cline{2-4} 
                                         & Hop-Count & 7.32  & 0.51   \\ \cline{2-4} 
\multirow{\textbf{Lennard-Jones}} & Stigmergy & N.A.  & 100.00 \\ \hline
                                         & RASS      & 12.68 & 1.67   \\ \cline{2-4} 
                                         & Hop-Count & 7.76  & 0.57   \\ \cline{2-4} 
\multirow{\textbf{Random Search}} & Stigmergy & N.A.  & 100.00 \\ \hline
\end{tabular}
\vspace{-3mm}
\end{table}
